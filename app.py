...
systolic = st.number_input("Systolic BP", min_value=80, max_value=200)
diastolic = st.number_input("Diastolic BP", min_value=40, max_value=130)
chol = st.number_input("Cholesterol", min_value=80, max_value=400)
...
if st.button("Predict"):
    ...
    if prediction == 1:
        ...
        st.success("### Result: NO ")
        st.write("No Diabetic Retinopathy.")